...
const socketAddress = io.httpServer.address().address;
const socketPort = io.httpServer.address().port;
console.log('Socket server started on ',socketAddress , socketPort);
...
io.on('connection',(socket)=>{
  ...
  // Set the CORS origin for each socket connection
  socket.handshake.headers.origin = SOCKET_CORS_ORIGIN;
